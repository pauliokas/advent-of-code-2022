...
[sprite](<https://en.wikipedia.org/wiki/Sprite_(computer_graphics)>). Specifically, the sprite is 3 pixels wide, and the
`X` register sets the horizontal position of the _middle_ of that sprite. (In this system, there is no such thing as
...
[<span title="While you're at it, go watch everything else by Retro Game Mechanics Explained, too.">timing</span>](https://www.youtube.com/watch?v=sJFnWZH5FXc)
...
drawn, the screen produces a _lit_ pixel (`#`); otherwise, the screen leaves the pixel _dark_ (`.`).
