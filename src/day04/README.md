...
in need of reconsideration. In this example, there are _`2`_ such pairs.
...
<span title="If you like this, you'll *love* axis-aligned bounding box intersection testing.">like</span> to know the
number of pairs that _overlap at all_.
