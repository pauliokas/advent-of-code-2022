...
of geodes that can be opened in 24 minutes using that blueprint. In this example, the first blueprint has ID 1 and can
...
first three blueprints. **What do you get if you multiply these numbers together?**
